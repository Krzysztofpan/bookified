...
const useFormField = () => {
  ...
  /** Full formState subscription so `errors` are visible to `getFieldState` (scoped `name` alone omits errors). */
...
function FormLabel({ className, ...props }: React.ComponentProps<typeof LabelPrimitive.Root>) {
  ...
  return <LabelPrimitive.Root data-slot='form-label' data-error={!!error} className={cn("data-[error=true]:text-destructive", className)} htmlFor={formItemId} {...props} />
}
