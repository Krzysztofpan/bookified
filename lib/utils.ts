...
export async function parsePDFFile(file: File) {
  try {
    // Legacy build includes Uint8Array#toHex polyfills and matches older browsers; default
    // build + wrong worker URL in Next.js often causes "toHex is not a function" inside the worker.
